    ...
    public function handle()
    {
        try{
            ...
            // Ask for category through the CLI with Category validation
                ...
                $category_id = $this->ask('What Is the product category name ? , choose a category between these cartegorie above, or put NULL : ');
            ...
            $createdProduct = $this->repository->storeProduct((object) $data );
